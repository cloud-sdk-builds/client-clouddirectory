...
[`@aws-sdk/client-clouddirectory`](https://www.npmjs.com/package/@aws-sdk/client-clouddirectory/v/3.0.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-clouddirectory@3.0.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xGyWu5eR0JwXyZmUM0vlIO5PYy0ZNGs5mzznCQ1ROip/UZSUV33syPd4XmYHVAHi
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-clouddirectory": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-clouddirectory@3.0.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-clouddirectory@3.0.0/index.min.mjs": "sha384-xGyWu5eR0JwXyZmUM0vlIO5PYy0ZNGs5mzznCQ1ROip/UZSUV33syPd4XmYHVAHi"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-clouddirectory/blob/refs/tags/3.0.0/LICENSE
```
